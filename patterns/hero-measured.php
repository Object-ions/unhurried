<?php
/**
 * Title: Hero, measured type
 * Slug: unhurried/hero-measured
...
<div class="wp-block-group alignfull is-style-section-ground" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:calc(clamp(80px, 11vw, 160px) + 2.5rem)">
	...
	<p class="is-style-eyebrow unhurried-indent unhurried-reveal" style="margin-bottom:clamp(2rem, 8vh, 6rem)"><?php esc_html_e( 'A studio for skin and slow care', 'unhurried' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-group unhurried-indent unhurried-reveal" style="margin-top:clamp(2.5rem, 8vh, 6rem)">
		...
		<p class="has-contrast-2-color has-text-color has-large-font-size" style="line-height:1.45"><?php esc_html_e( 'We work with precision and restraint, and we never rush the result.', 'unhurried' ); ?></p>
		<!-- /wp:paragraph -->
		<!-- wp:buttons {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|60"}}}} -->
		<div class="wp-block-buttons">
			<!-- wp:button -->
			<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Book a consultation', 'unhurried' ); ?></a></div>
			<!-- /wp:button -->
